-- ST6IX Gamma V1.8 HDR unified photographic rendering system
...
function init_pure_script()
    ...
    pure.script.ui.addText('ST6IX Gamma V1.8 HDR - unified photographic rendering controls for HDR displays.')
...
function update_pure_script(dt)
    ...
    pure.config.set('pp.saturation', colorSat * number('HDR Saturation',1,0.8,1.2), true)
    pure.config.set('pp.contrast', contrast * hdrContrast, true)
