-- ST6IX PP V1.1 HDR: photographic post-processing for Assetto Corsa
-- Pure Gamma 3.50 / CSP HDR output (DXGI flip model + HDR support)
-- Weather-adaptive lighting, sky, fog, bloom, glare, exposure and
-- reflections, with ST6IX skydomes and film grain, plus HDR & clarity.
...
function init_pure_script()
    ...
    pure.script.ui.addRadioButtons('Skydome Preset', 1, 'Off🌍,ST6IX Nebula🌌,ST6IX Madara🔴,ST6IX Black Hole🕳️,ST6IX Black Matter⚫,ST6IX Black Matter Colour🟣,Pure Sky🌤️')
